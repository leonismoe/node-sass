...
/**
 * get last import path (absolute)
 *
 * @api public
 * @return string
 */

module.exports.getLastImportPath = function() {
  return binding.getLastImportPath();
};

/**
 * get import absolute path's stack
 *
 * @api public
 * @return Array<string>
 */

module.exports.getImportStack = function() {
  return binding.getImportStack();
};
